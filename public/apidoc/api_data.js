define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "email",
            "description": "<p>Email de usuário cadastrado</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "password",
            "description": "<p>Senha de usuário cadastrado</p>"
          }
        ]
      },
      "examples": [
  ...
  },
  {
    ...
    "header": {
      ...
      "examples": [
        {
          "title": "Header",
          "content": "{\"Authorization\": \"Bearer xyz.abc.123\"}",
          "type": "json"
        }
      ]
    },
  ...
  },
  {
    "type": "get",
    "url": "/tasks",
    "title": "Exibe todas as tarefas registradas",
    "group": "Tasks",
    "header": {
      "fields": {
        "Header": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>Id do usuário que cadastrou a tarefa</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
        ...
        "Header": [
          {
            ...
            "optional": false,
            "field": "Authorization",
            "description": "<p>Token de usuário válido</p>"
          }
        ]
      },
      "examples": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "done",
            "description": "<p>A Tarefa foi concluída?</p>"
          },
          {
            "group": "Success 200",
            "type": "Date",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "Sucesso",
            "description": "<p>HTTP/1.1 200 OK { &quot;id&quot;: 1, &quot;name&quot;: &quot;john&quot;, &quot;email&quot;: &quot;john@email.com&quot; }</p>"
          }
        ]
      }
    },
